                                ...
                                <div class="col-md-8">
                                    ...
                                    <?php if ($pending_application['current_status'] === 'rejected'): ?>
                                        <div class="alert alert-danger mt-3 mb-3">
                                            ...
                                            <?php if (!empty($pending_application['dealer_remarks'])): ?>
                                                <!-- Rejected by Dealer -->
                                                <p class="mb-1"><?php echo nl2br(htmlspecialchars($pending_application['dealer_remarks'])); ?></p>
                                                <small class="text-muted">
                                                    Rejected by Dealer on: <?php echo date('d-m-Y H:i', strtotime($pending_application['dealer_reviewed_at'])); ?>
                                                </small>
                                            <?php elseif (!empty($pending_application['co_remarks'])): ?>
                                                <!-- Rejected by CO -->
                                                <p class="mb-1"><?php echo nl2br(htmlspecialchars($pending_application['co_remarks'])); ?></p>
                                                <small class="text-muted">
                                                    Rejected by <?php echo htmlspecialchars($pending_application['co_name'] ?? 'CO'); ?> on: <?php echo date('d-m-Y H:i', strtotime($pending_application['co_reviewed_at'])); ?>
                                                </small>
                                            <?php else: ?>
                                                <p class="mb-1">No specific reason provided.</p>
                                            <?php endif; ?>
                                        </div>
                                        <p class="text-muted">

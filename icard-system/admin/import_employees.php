...
function processExcelFile($file_path, $extension) {
    ...
    if ($extension === 'csv') {
        ...
        if ($handle) {
            ...
            $row_count = 0;
            while (($row = fgetcsv($handle)) !== FALSE && $row_count < 50) { // Limit preview to 50 rows
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-muted">
                            <small>Showing first 20 records. Total records to import: <?php echo count($preview_data); ?></small>
                        </div>
                        <?php endif; ?>

...
// Get some basic statistics without using functions.php
...
// Count applications - handle if table doesn't exist yet
$applicationCount = 0;
try {
...
// Count generated I-Cards - handle if table doesn't exist yet
$icardCount = 0;
try {
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                            System Status</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $systemStatus; ?></div>
                                    </div>
                                    <div class="col-auto">

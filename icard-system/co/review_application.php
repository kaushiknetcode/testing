...
if ($application_id > 0) {
    try {
        ...
        // Get application with employee details
        $sql = "SELECT a.*, e.name, e.emp_number, e.dob, e.category, d.name as department_name 
                FROM applications a 
        ...
        if ($stmt) {
            ...
            if ($result && $result->num_rows === 1) {
                ...
                $error = 'Application not found or not available for review.';
            }
            $stmt->close();
        }
    ...
    if (in_array($action, ['approve', 'reject'])) {
        try {
            ...
            if ($action === 'approve') {
                ...
                $success_message = 'Application approved and forwarded to dealer.';
            } else {
                // Reject application
                $new_status = 'rejected';
            ...
            if ($stmt) {
                ...
                if ($stmt->execute() && $stmt->affected_rows > 0) {
                    ...
                    // Log the action
                    $log_entry = date('Y-m-d H:i:s') . " - CO " . $_SESSION['username'] . " " . $action . "d application ID: " . $application_id . "\n";
                ...
                <div class="review-actions">
                    ...
                    <form method="POST" id="reviewForm">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="co_remarks" name="co_remarks" rows="4" required
                                      placeholder="Please provide your comments for this application..."></textarea>
                    ...
                    <div class="mt-4 p-3 bg-light rounded">
                        ...
                        <small class="text-muted">
                            ...
                            • Provide clear remarks for your decision
                        </small>
                    </div>
                </div>
            </div>
